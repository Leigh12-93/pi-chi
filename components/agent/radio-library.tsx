...
const GENRE_COLORS: Record<string, string> = {
  ...
  aussiehiphop: 'bg-yellow-500/20 text-yellow-300',
  midnight_drive: 'bg-violet-500/20 text-violet-300',
  golden_hour: 'bg-amber-400/20 text-amber-200',
  rise_up: 'bg-emerald-500/20 text-emerald-300',
  ocean_eyes: 'bg-sky-500/20 text-sky-300',
  friday_feeling: 'bg-rose-500/20 text-rose-300',
  backroads: 'bg-lime-500/20 text-lime-300',
  electric_love: 'bg-fuchsia-500/20 text-fuchsia-300',
  summer_down_south: 'bg-orange-400/20 text-orange-200',
  burn_it_down: 'bg-red-500/20 text-red-300',
  neon_paradise: 'bg-teal-500/20 text-teal-300',
  concrete_jungle: 'bg-zinc-500/20 text-zinc-300',
  old_school_flow: 'bg-amber-600/20 text-amber-300',
  catch_fire: 'bg-red-600/20 text-red-200',
  shadows: 'bg-slate-500/20 text-slate-300',
  west_side_story: 'bg-yellow-400/20 text-yellow-200',
  viral_moment: 'bg-pink-400/20 text-pink-200',
  drift_king: 'bg-neutral-500/20 text-neutral-300',
  island_time: 'bg-cyan-400/20 text-cyan-200',
}
