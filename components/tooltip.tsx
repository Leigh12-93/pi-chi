  ...
  return (
    <>
      ...
      {visible && mounted && createPortal(
        <div
          className={cn(
            'fixed z-[200] px-2 py-1 text-[11px] text-white bg-forge-bg border border-forge-border rounded-md shadow-lg pointer-events-none animate-scale-in whitespace-nowrap',
