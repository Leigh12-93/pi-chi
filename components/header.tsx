    ...
    <header className="h-11 flex items-center justify-between px-2 sm:px-4 border-b border-forge-border bg-forge-panel shrink-0">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        {status === 'loading' ? (
          ...
          <a
            href="/api/auth/login"
            className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1 rounded bg-forge-surface hover:bg-forge-accent/20 text-xs text-forge-text-dim hover:text-forge-text transition-colors"
          >
